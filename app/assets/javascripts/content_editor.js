...
$(function() {  
  if (typeof ContentEditor === 'undefined') {
    ContentEditor = {
      ...
      _saveUri: window.app_uri_prefix + '/editor_content/create',
      _publishUri: window.app_uri_prefix + '/editor_content/publish_draft',
      ...
      publishDraft: function() {
          ...
          $.ajax(ContentEditor._publishUri, {
            method: "POST",
            data: {
              state: {
  ...
  tinymce.baseURL = window.app_uri_prefix + '/assets/tinymce';
