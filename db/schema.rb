...
ActiveRecord::Schema.define(version: 20180928174422) do
  ...
  create_table "podcast_images", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "file_name"
    t.string "author"
    t.string "license"
